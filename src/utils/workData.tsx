...
export const workData = [
  {
    ...
    description:
      'Action! Welcome to Lukub, it is a simple movie app built with OMDB API. This is my latest achievement in asynchronous and dark mode features. Login screen is coming soon!',
    tech1: 'React',
    tech2: 'Vite',
    tech3: 'TypeScript',
    tech4: 'HTML',
  ...
  },
  {
    ...
    description:
      'The website was made for my friend, who is a hair stylist in San Diego, CA. She has exellent skills and techniques. Please check it out!',
    tech1: 'React',
    tech2: 'Vite',
    tech3: 'JavaScript',
    tech4: 'HTML',
  ...
  },
  {
    ...
    description:
      'Discover the functionality of the sticky notes in the app, enabling you to carry your ideas wherever you go!',
    tech1: 'React',
    tech2: 'Vite',
    tech3: 'JavaScript',
    tech4: 'HTML',
